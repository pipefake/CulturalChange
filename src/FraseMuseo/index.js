...
function DraggableWord({ word, onDrop, isDraggable, sentence, isDraggedToDropSpace }) {
    ...
    return (
        <div
            ref={ref}
            className={`draggable-word ${isDraggable || !isWordInSentence || isDraggedToDropSpace ? '' : 'dragged'}`}
            style={{ opacity }}
        >
            {word}
        </div>
...
function FraseMuseo({ historia }) {
    ...
    useEffect(() => {
        if (draggedWordsInDropSpace === sentence.length && matchedPairs < sentence.length) {
    ...
    const handleWordDrop = (word, index, historia) => {
        ...
        if ((word === pair1[0] && index === pair1[1]) ||
            (word === pair2[0] && index === pair2[1]) ||
            (word === pair3[0] && index === pair3[1]) ||
            (word === pair4[0] && index === pair4[1])) {
            // Las parejas coinciden
            if (word === pair1[0]) {
                console.log(`La DraggableWord '${word}' ha sido colocada en el DropSpace con key=${index}.`);
            ...
            console.error("Error: La pareja de DraggableWord y DropSpace no coincide.");
        }
    ...
    return (
        ...
        <DndProvider backend={HTML5Backend}>
                ...
                <div className="complete-the-sentence">
                    ...
                    {historia === 1 && (
                        <div className="sentence frase1">
                            ...
                            <p className="txtFrase">la cultura y la preservación del legado ancestral </p>
                    ...
                    {historia === 2 && (
                        <div className="sentence frase2">
                            ...
                            <p className="txtFrase"> malagana y yotoco, nos revelan en sus  </p>
                            {sentence[1] ? (
                                <span className="txtPalabra" key={1} style={txtPalabraStyle}>
                                    {sentence[1]}
                                </span>
                            ...
                            <p className="txtFrase">antropomorfas, zoomorfas y fitomorfas, la </p>
                            <p className="txtFrase">asombrosa  creatividad y conexión con la naturaleza </p>
                    ...
                    {historia === 3 && (
                        <div className="sentence frase3">
                            <p className="txtFrase">Los volantes de huso, más que simples herramientas, </p>
                            ...
                            <p className="txtFrase"> quimbaya y yotoco. Sus diseños celestiales y  </p>
                            <p className="txtFrase">  naturales inspiraron incluso al reconocido artista </p>
                            <p className="txtFrase">  colombiano Omar Rayo, quien vio en ellos una  </p>
                            {sentence[3] ? (
                                <span className="txtPalabra" key={3} style={txtPalabraStyle}>
                                    {sentence[3]}
                                </span>
                            ...
                            <p className="txtFrase">inagotable de creatividad geométrica.
                            </p>
                        </div>
                    )}
                    {historia === 4 && (
                        <div className="sentence frase4">
                            <p className="txtFrase">Las urnas funerarias, guardianas de secretos ancestrales,</p>
                            ...
                            <p className="txtFrase"> civilizaciones pasadas.   Desde las antropomorfas Quimbayas</p>
                            ...
                            <p className="txtFrase">la diversidad cultural de épocas olvidadas.</p>
                    ...
                    {historia === 5 && (
                        <div className="sentence frase5">
                            ...
                            <p className="txtFrase"> sumergen en rituales y festividades olvidadas.  </p>
                            ...
                            <p className="txtFrase">zoomorfo del ave Tulcán, cuyo sonido estaba destinado a  </p>
                            <p className="txtFrase"> los rituales espirituales de los Andes. </p>
            ...
            {showPerdieron && (
                <div className="perdieron">Perdieron</div>
            )}
        </DndProvider>
